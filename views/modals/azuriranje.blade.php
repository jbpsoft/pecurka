...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <form method="post" action="{{ AdminOptions::base_url() }}admin-update-worker/{{ $data->radnici_id }}">
    <div class="modal-body">
      ...
      <select class="form-group row" id="sel1" name="nacin_zarade" autocomplete="off">
