...
<nav>
  <ul class="mcd-menu">
    ...
    <li>
      ...
      <ul>
        <li><a href="{{ AdminOptions::base_url() }}workers" >
            <i class="fa fa-male"></i>
            {{ AdminOptions::lang(51, Session::get('jezik.AdminOptions::server()')) }}
          </a>
            
            <ul>
              <li>
                <a href="#" class="zaradaRadnik" aria-hidden="true">
                    <i class="fa fa-edit"></i>
                    {{ AdminOptions::lang(50, Session::get('jezik.AdminOptions::server()')) }}
                </a>
              </li>
            </ul>  
        </li>
